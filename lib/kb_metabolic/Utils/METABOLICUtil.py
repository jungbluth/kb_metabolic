...
class DASToolUtil:
    DASTOOL_THREADS=2
    BINNER_RESULT_DIRECTORY = 'metabolic_output_dir'
    BINNER_BIN_RESULT_DIR = 'metabolic_output_dir_DASTool_bins'
    ...
    def validate_run_metabolic_params(self, params):
        """
        validate_run_concoct_params:
                validates params passed to run_concoct method

        """
        log('Start validating run_kb_metabolic params')
    ...
    def generate_output_file_list(self, result_directory):
        ...
        result_file = os.path.join(output_directory, 'metabolic_result.zip')
        report_file = None
        ...
        output_files.append({'path': result_file,
                             ...
                             'description': 'Files generated by kb_metabolic App'})
    ...
    def generate_report(self, binned_contig_obj_ref, params):
        ...
        report_params = {
              ...
              'report_object_name': 'kb_metabolic_report_' + str(uuid.uuid4())}
    ...
    def rename_and_standardize_bin_names(self):
        ...
        path_to_result_bins = os.path.join(self.scratch, self.BINNER_RESULT_DIRECTORY, "metabolic_output_dir_DASTool_bins")
    ...
    #     """
    #     log("\n\nRunning make_binned_contig_summary_file_for_binning_apps")
    #     path_to_result = os.path.join(self.scratch, self.BINNER_RESULT_DIRECTORY, "metabolic_output_dir_DASTool_bins")
    ...
    def generate_metabolic_input_files_and_commands_from_binned_contigs(self, params):
    ...
    def generate_metabolic_command(self, params, trimmed_binned_contig_name_list, contig_to_bin_file_name_list):
        """
        ...
        print("\n\nRunning generate_metabolic_command")
        ...
        log('Generated metabolic command: {}'.format(command))

        return command

    def run_metabolic(self, params):
        """
        run_metabolic: DAS_Tool app
        ...
        """
        log('--->\nrunning DASToolUtil.run_metabolic\n' +
            'params:\n{}'.format(json.dumps(params, indent=1)))

        self.validate_run_metabolic_params(params)

        print("\n\nFinished running validate_run_metabolic_params")
        #
        ...
        (trimmed_binned_contig_name_list, contig_to_bin_file_name_list) = self.generate_metabolic_input_files_and_commands_from_binned_contigs(params)
        comma_symbol = ','
        ...
        #run concoct
        command = self.generate_metabolic_command(params, trimmed_binned_contig_name_list, contig_to_bin_file_name_list)
        ...
        task_params['bin_result_directory'] = os.path.join(self.BINNER_RESULT_DIRECTORY , "metabolic_output_dir_DASTool_bins")
        ...
        generate_binned_contig_param = {
            'file_directory': os.path.join(self.scratch, self.BINNER_RESULT_DIRECTORY , "metabolic_output_dir_DASTool_bins"),
